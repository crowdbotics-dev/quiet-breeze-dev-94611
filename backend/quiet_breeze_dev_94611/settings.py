"""
Django settings for quiet_breeze_dev_94611 project.
...
ROOT_URLCONF = 'quiet_breeze_dev_94611.urls'
...
WSGI_APPLICATION = 'quiet_breeze_dev_94611.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_breeze_dev_94611 API",
    "DESCRIPTION": "API documentation for quiet_breeze_dev_94611 App",
    "VERSION": "v1",
}
